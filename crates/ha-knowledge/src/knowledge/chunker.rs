...
// 类型已下沉 ha-config-schema，此处原地再导出保持 `crate::knowledge::chunker::*`
// 路径不变。
pub use ha_config_schema::knowledge::chunker::{
    ChunkConfig, DEFAULT_MAX_CHUNK_CHARS, DEFAULT_OVERLAP_CHARS,
};
