...
use ha_core::stt::resolve_active;
...
impl SttSessionManager {
    ...
    pub async fn start(
        ...
        let active = match (provider_id, model_id) {
            ...
            _ => {
                let (primary, _) = ha_core::stt::current_desktop_chain();
        ...
        let mut usage_event =
            ha_core::model_usage::ModelUsageEvent::new(ha_core::model_usage::KIND_STT);
        ...
        ha_core::model_usage::record_model_usage_best_effort(usage_event);
...
fn spawn_event_pump(
    ...
    tokio::spawn(async move {
        let bus = ha_core::globals::get_event_bus();
...
mod tests {
    ...
    use ha_core::stt::crud::add_stt_provider_in_config;
    use ha_core::stt::types::{SttModelConfig, SttProviderConfig, SttProviderKind};
    ...
    async fn start_without_any_model_returns_no_active_model() {
        ...
        let _config_restore = ha_core::test_support::replace_config_cache(AppConfig::default());
