...
use ha_core::stt::types::{SttModelConfig, SttProviderConfig, TranscriptDelta, TranscriptOptions};
...
pub async fn open_stream(
    ...
    let api_secret =
        ha_core::stt::types::require_extra(provider, "api_secret", "APISecret")?.to_string();
    let app_id = ha_core::stt::types::require_extra(provider, "app_id", "APPID")?.to_string();
    ...
    ha_core::stt::types::check_ssrf(provider, &https_twin).await?;
