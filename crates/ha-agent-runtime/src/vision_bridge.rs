//! Vision bridge (issue #434), owned by the main-turn runtime.
//!
...
use super::types::{AssistantAgent, Attachment, ProviderFormat};
...
#[doc(hidden)]
pub struct ResolvedVisionBridge {
...
#[doc(hidden)]
pub fn prepare(session_id: Option<&str>, incognito: bool) -> Option<ResolvedVisionBridge> {
...
impl ResolvedVisionBridge {
    ...
    #[doc(hidden)]
    pub fn vision_model_id(&self) -> &str {
