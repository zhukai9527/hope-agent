...
//! [`ha_core::tools::execution::execute_tool_with_context`] looks uniform.
//!
...
/// [`ha_core::tools::execution`] *before* we get here. It's kept in the
...
fn emit_learning(
    entry: &crate::registry::ToolIndexEntry,
    namespaced_name: &str,
