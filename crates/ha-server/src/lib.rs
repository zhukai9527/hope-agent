...
fn build_router_with_cors(
    ...
    let api = Router::new()
        ...
        .route(
            "/skills/dock-snapshot",
            get(routes::skills::get_skill_dock_snapshot),
        )
        .route(
            "/skills/registry",
            get(routes::skills::get_skill_registry_snapshot),
        )
        .route(
            "/skills/market/default",
            get(routes::skills::get_default_skill_market_snapshot),
        )
        .route(
            "/skills/market/snapshot",
            post(routes::skills::get_skill_market_snapshot),
        )
        .route(
            "/skills/market/sources",
            get(routes::skills::get_skill_market_sources)
                .post(routes::skills::set_skill_market_sources),
        )
        .route(
            "/skills/market/hubs",
            get(routes::skills::get_skill_market_hub_config),
        )
        .route(
            "/skills/market/hubs/upsert",
            post(routes::skills::upsert_skill_market_hub),
        )
        .route(
            "/skills/market/hubs/delete",
            post(routes::skills::delete_skill_market_hub),
        )
        .route(
            "/skills/market/hubs/enabled",
            post(routes::skills::set_skill_market_hub_enabled),
        )
        .route(
            "/skills/market/hubs/token/status",
            post(routes::skills::get_skill_market_hub_token_status),
        )
        .route(
            "/skills/market/hubs/token/set",
            post(routes::skills::set_skill_market_hub_token),
        )
        .route(
            "/skills/market/hubs/token/clear",
            post(routes::skills::clear_skill_market_hub_token),
        )
        .route(
            "/skills/market/registries/upsert",
            post(routes::skills::upsert_skill_market_registry),
        )
        .route(
            "/skills/market/registries/delete",
            post(routes::skills::delete_skill_market_registry),
        )
        .route(
            "/skills/market/publish/draft",
            post(routes::skills::create_skill_publish_draft),
        )
        .route(
            "/skills/market/publish/push",
            post(routes::skills::push_skill_to_market_hub),
        )
        .route(
            "/skills/market/install",
            post(routes::skills::install_remote_market_skill),
        )
        .route(
            "/skills/market/update",
            post(routes::skills::update_remote_market_skill),
        )
        .route(
            "/skills/registry/install",
            post(routes::skills::install_registry_skill),
        )
        .route(
            "/skills/registry/update",
            post(routes::skills::update_registry_skill),
        )
        .route(
            "/skills/app/install",
            post(routes::skills::install_skill_to_app),
        )
        .route(
            "/skills/app/uninstall",
            post(routes::skills::uninstall_skill_from_app),
        )
        .route(
            "/skills/managed/uninstall",
            post(routes::skills::uninstall_managed_skill),
        )
        .route("/skills/usage/scan", get(routes::skills::scan_skill_usage))
        .route(
            "/skills/zip/dry-run",
            post(routes::skills::dry_run_import_skill_zip),
        )
        .route("/skills/zip/import", post(routes::skills::import_skill_zip))
        .route(
            "/skills/zip/import-renamed",
            post(routes::skills::import_skill_zip_renamed),
        )
        .route("/skills/zip/export", post(routes::skills::export_skill_zip))
        .route(
            "/skills/mentionable",
