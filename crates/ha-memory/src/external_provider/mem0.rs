...
use ha_core::memory::{ExternalMemoryProviderConfig, MemoryEntry};
...
impl ExternalMemoryProviderAdapter for Mem0Adapter {
    fn kind(&self) -> ha_core::memory::ExternalMemoryProviderKind {
        ha_core::memory::ExternalMemoryProviderKind::Mem0
    }
...
mod tests {
    use super::*;
    use ha_core::memory::ExternalMemorySyncPolicy;
    ...
    fn own_exports_are_not_reimported() {
        let provider = ExternalMemoryProviderConfig {
            id: "mem0-main".into(),
            kind: ha_core::memory::ExternalMemoryProviderKind::Mem0,
