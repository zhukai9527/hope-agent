...
use ha_core::memory::ExternalMemoryProviderConfig;
...
impl ExternalMemoryProviderAdapter for SupermemoryAdapter {
    fn kind(&self) -> ha_core::memory::ExternalMemoryProviderKind {
        ha_core::memory::ExternalMemoryProviderKind::Supermemory
    }
...
mod tests {
    ...
    fn parses_list_envelope_and_detects_own_export() {
        ...
        let provider = ExternalMemoryProviderConfig {
            id: "super-main".into(),
            kind: ha_core::memory::ExternalMemoryProviderKind::Supermemory,
            display_name: "Supermemory".into(),
            enabled: true,
            sync_policy: ha_core::memory::ExternalMemorySyncPolicy::Bidirectional,
