...
pub fn spawn_startup_notifier(registry: Arc<ChannelRegistry>) {
    ...
    tokio::spawn(async move {
        ...
        let Some(channel_db) = ha_core::get_channel_db() else {
            app_warn!(
                "channel",
                "startup_notifier",
        ...
        let startup_text = ha_core::i18n::localized_backend_message(
            ha_core::i18n::BackendMessage::StartupBackOnline,
        ...
        let mut tasks: JoinSet<(
            ...
            String,
            String,
            anyhow::Result<ha_core::channel::types::DeliveryResult>,
        )> = JoinSet::new();
        for conv in targets {
