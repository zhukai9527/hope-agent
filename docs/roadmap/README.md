...
| [Coding Eval 体系方案](coding-eval.md) | Phase 0 人工 gold task 体系 + Phase 3.7-5.3 已落地的确定性控制面 eval / agent execution / task-level runner / Gold Task Pack v1 索引 |
