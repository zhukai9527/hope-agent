...
| 文档 | 说明 |
| --- | --- |
| [Agent 控制平面路线图](agent-control-plane-roadmap.md) | 新主线：通用 Agent 控制平面先稳住，再以 coding-first 落地；Managed Worktree / LSP / Review / Smart Verification 已完成，后续继续搜索与 review/verification 深水增强 |
