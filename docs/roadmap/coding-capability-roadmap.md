...
- Gold task pack 扩张：把当前 5 个 active automated cases 扩到 Phase 0 的 20 个任务。
...
- 内置 Gold Task Pack v1：5 个 active gold tasks（`CE-TEST-004`、`CE-RUST-001`、`CE-REV-002`、`CE-NAV-001`、`CE-NAV-002`）已自动化。
...
- 不声称 20 个草案全部自动化；draft 任务仍需人工试跑校准后纳入 pack。
