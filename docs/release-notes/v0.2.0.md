...
每次升级强制 `ask_user_question` 走 Yes/No 二次确认，跳过签名校验的路径不存在。详见 [`docs/architecture/infra/self-update.md`](https://github.com/shiwenwen/hope-agent/blob/v0.2.0/docs/architecture/infra/self-update.md)。
