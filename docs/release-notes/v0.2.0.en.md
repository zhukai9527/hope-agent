...
Every upgrade goes through an `ask_user_question` Yes/No confirmation — there is no path that skips signature verification. See [`docs/architecture/infra/self-update.md`](https://github.com/shiwenwen/hope-agent/blob/v0.2.0/docs/architecture/infra/self-update.md).
