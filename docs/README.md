...
| [Context Retrieval v2](architecture/context-retrieval.md) | 任务感知上下文推荐：聚合 Git diff、历史 artifacts、LSP diagnostics/symbols、Review findings、Verification steps、file search v2 与 URL 来源，Workspace 推荐上下文区块 | `context_retrieval.rs`, `lsp.rs`, `components/chat/workspace/` |
