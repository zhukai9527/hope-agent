...
> 返回 [技术文档索引](../README.md)
>
> 状态：Phase 5.5 已实现。本文只记录已经落地的自动化评测层；人工 gold task 体系仍见 [Coding Eval 体系方案](../roadmap/coding-eval.md)。
...
| `crates/ha-core/tests/fixtures/coding_eval/*.json` | Phase 3.7-5.2 控制面、执行与任务级 JSON fixture；Phase 5.5 Gold Task Pack 由 `coding_eval.rs` typed registry 生成 fixture。 |
