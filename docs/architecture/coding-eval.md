...
> 返回 [技术文档索引](../README.md)
>
> 状态：Phase 6.3 已实现。本文只记录已经落地的自动化评测层；人工 gold task 体系仍见 [Coding Eval 体系方案](../roadmap/coding-eval.md)。
