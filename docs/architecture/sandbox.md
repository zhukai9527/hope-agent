# Sandbox 架构
> 返回 [文档索引](../README.md) | 更新时间：2026-07-23 | 关联：[权限/审批系统](permission-system.md) · [工具系统](tool-system.md) · [配置系统](config-system.md) · [API 参考](api-reference.md)
...
- Windows 已有默认 WSL 发行版但未装 Docker Engine：优先展示 WSL 内 Engine 安装入口，无需强制安装 Docker Desktop。
